...
type Auth struct {
	...
	PlayerTenantSigning *JwtSigning `protobuf:"bytes,2,opt,name=player_tenant_signing,json=playerTenantSigning,proto3" json:"player_tenant_signing,omitempty"`
}
...
func (x *Auth) GetPlayerTenantSigning() *JwtSigning {
	if x != nil {
		return x.PlayerTenantSigning
	}
	return nil
}
...
var file_config_pb_config_proto_rawDesc = []byte{
	...
	0x67, 0x12, 0x42, 0x0a, 0x15, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x74, 0x65, 0x6e, 0x61,
	0x6e, 0x74, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x4a, 0x77, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67,
	0x52, 0x13, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x53, 0x69,
...
var file_config_pb_config_proto_depIdxs = []int32{
	...
	8, // 8: pb.Auth.player_tenant_signing:type_name -> pb.JwtSigning
